...
if __name__ == '__main__':
    ...
    # Функция для обработки нажатия на Inline кнопку "Назад"
    ...
    # Обработчик для всех типов обновлений, которые не были обработаны другими хендлерами
    @dp.update()
    async def handle_unprocessed_updates(update: types.Update):
        logging.info(f"Unprocessed update: {update}")
